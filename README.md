...
```bash
curl -o /usr/bin/tactu_cpanel -s -L https://raw.githubusercontent.com/kanu2005/cPanel-nulled/main/tactu_cpanel
...
```bash
curl -o /root/cpanel_update -s -L https://raw.githubusercontent.com/kanu2005/cPanel-nulled/main/tactu_cpanel
